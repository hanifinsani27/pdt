            ...
            <nav class="navbar navbar-expand-lg navbar-light sticky-top">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="adminField.php" style="margin-right:20px">Jadwal</a>
                    </li>
                </ul>
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <div class="form-group">
                            <select name = "field" class="form-control" required>
                                ...
                                <option value="2">Pengetahuan Sosial</option>
                                <option value="3">Pengembangan Moral</option>
                                <option value="4">Konsep Matematika</option>
                            </select>   
                    </div>
                </div>
                <button type="submit" class="btn btn-primary mb-2" name="date_search">Cari!</button>
            </form>
        </div>
        <?PHP
