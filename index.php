    ...
    <div class="site-content">
        <header>
            <nav class="navbar navbar-expand-lg navbar-light sticky-top">
                ...
                <img src="res/img/logo.jpeg" width="150" height="85,5" class="d-inline-block align-top" alt=""> </a>
        ...
        <div class="landing-text ml-5">
            <h1 style="margin-top: 10%"><font color="white">Tetap Belajar</font></h1> 
            <h1 ><font color="white">Dengan Mentoring Online</font></h1>
        </div>
