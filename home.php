...
<head>
    ...
    <title>Login - WeMeet</title>

    <style>
    body { 
        background: url("res/img/home1.jpg") no-repeat fixed center;
        height: 100%; 
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light sticky-top">
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href = "daftarmentoring.php"  style="margin-Left:20px"><font color="white">Daftar Mentoring</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active"  href = "hasil.php"style="margin-Left:40px"><font color="white">Hasil Mentoring</a>
                </li>  
            </ul> 
    ...
    <div class="mt-3 ml-4 mb-1" style="max-width: 60%">
        <h1><font color="f29200">Pemesanan Mentoring</font></h1>
        <p><font color="f29200">Cari Ketersediaan</font></p>
        ...
        <form action="home.php" method="POST" class="form-inline">
            ...
            <div class="form-group mx-sm-3 mb-2">
                <div class="form-group">
                        <select name = "Mata Pelajaran" class="form-control" required>
                            <option disabled>Mata Pelajaran</option>
                            <option value="1">Pengetahuan Alam</option>
                            <option value="2">Pengembangan Moral</option>
                            <option value="3">Pengetahuan Sosial</option>
                            <option value="4">Konsep matematika</option>
                        </select>   
                </div>
            </div>
            <button type="submit" class="btn btn-warning mb-2" name="date_search"><font color="043752">Cari!</font></button>
        </form>
    </div>
